...
- 専用identity/schema versionを持つlocal SQLite catalog、strict create/open、source hash/capture id冪等性、song 1:N、`image_kind` と全768 thumbnail・histogram・dHash永続化を追加した。kind訂正時は同じreferenceの特徴量を再計算する。
